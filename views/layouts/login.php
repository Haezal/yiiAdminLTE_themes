  ...
  <body class="login-page">
    <div class="login-box" style="width: 450px;">
      <div class="login-logo">
        <a href="<?php echo Yii::app()->createUrl('/');?>"><b><?php echo Yii::app()->name; ?></b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <?php echo $content ?>
        <a href="<?php echo Yii::app()->createUrl('user/recovery') ?>">Forgot Password</a><br>
        <a href="<?php echo Yii::app()->createUrl('user/registration') ?>" class="text-center">Register Account</a>
